 ...
 * module data. It runs after hook_flush_caches() so it can be assumed all module
 * data fetched here is fresh/current.
 *
 * IMPORTANT: Do not call exit() within this hook. It will stop execution of
 * all subsequent rebuild hooks and will annoy alot of people.
 */
